...
\item Used collaborative filtering, clustering, heuristics, and semi-supervised training
	techniques to extract meaningful insights from large-scale unlabeled
...
\noindent
%
Python, SQL, C\verb!++!, Java, OCaml, Haskell, C.
%
\archive{
