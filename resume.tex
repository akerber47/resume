...
Thesis: \emph{Quasi-Fuchsian surface subgroups of
...
{\it Phi Beta Kappa, magna cum laude, dept.\ honors, David Howell Premium
(\$5000, 1 awarded/year)}\\
\qquad GPA: 3.89/4.00 \ \ \ CS GPA: 4.00/4.00 \ \ \ Math GPA: 4.00/4.00\\
\vspace{-4ex}
...
\projecthead{2013\,--}{Haskell Compiler}
\vspace{0.5ex}
...
and LLVM code generation phases. OCaml.
...
Has potential to save Berkeley math dept over 500 man-hours per
semester. Python.

\phantom{Words}

% or 2012
\projecthead{2012\,--}{Bestvina--Handel Algorithm (PhD Research)}
\vspace{0.5ex}
\\Library that uses sophisticated graph algorithms to
compute and display train track invariants of surface maps.
May yield an explicit solver for pseudo-Anosov map conjugacy (open problem). Haskell.
\end{jobs}
...
\noindent C, Haskell, Python, shell, OCaml, Scheme
(Racket), R, Java, C\verb!++!.\\
Linux (Ubuntu,
Debian, Arch), VCS (svn, hg, git), vim, make, HTML, CSS.
